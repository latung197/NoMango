...
const mockColors = [
  { id: 'WHITE', code: 'WHITE', name: 'White', type: 'solid', hexCode: '#FFFFFF', status: 'active', updatedBy: 'Admin', updatedDate: '2024-01-10' },
  { id: 'BLUE', code: 'BLUE', name: 'Blue', type: 'solid', hexCode: '#0066CC', status: 'active', updatedBy: 'Admin', updatedDate: '2024-01-10' },
  { id: 'RED', code: 'RED', name: 'Red', type: 'solid', hexCode: '#CC0000', status: 'active', updatedBy: 'Planner', updatedDate: '2024-01-09' },
  { id: 'GREEN', code: 'GREEN', name: 'Green', type: 'solid', hexCode: '#00AA00', status: 'active', updatedBy: 'Admin', updatedDate: '2024-01-09' },
  { id: 'BLACK', code: 'BLACK', name: 'Black', type: 'solid', hexCode: '#000000', status: 'active', updatedBy: 'Admin', updatedDate: '2024-01-08' },
  { id: 'TRANS-CLEAR', code: 'TRANS-CLEAR', name: 'Transparent Clear', type: 'transparent', hexCode: '#F0F0F0', status: 'active', updatedBy: 'Planner', updatedDate: '2024-01-08' }
];
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-center space-x-2">
              <Switch
                ...
                onCheckedChange={(checked) => setProductForm(prev => ({ ...prev, status: checked }))}
              />
          ...
          <div className="flex gap-2 pt-4 justify-end">
            ...
            <Button variant="outline" onClick={() => handleReset('product')}>
              ...
              <TableBody>
                {mockProducts.map((product) => (
                  <TableRow key={product.id}>
                    ...
                    <TableCell>{product.updatedDate}</TableCell>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select value={colorForm.type} onValueChange={(value) => setColorForm(prev => ({ ...prev, type: value }))}>
                <SelectTrigger>
                  <SelectValue placeholder="Select type" />
                </SelectTrigger>
                <SelectContent>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select 
                value={parentChildMappingForm.relationshipType}
                onValueChange={(value) => setParentChildMappingForm(prev => ({ ...prev, relationshipType: value }))}
              >
                <SelectTrigger>
                  <SelectValue placeholder="Select type" />
                </SelectTrigger>
